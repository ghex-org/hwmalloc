...
inline constexpr std::size_t tiny_segment_size_default = 16384u;
inline constexpr std::size_t small_segment_size_default = 32768u;
inline constexpr std::size_t large_segment_size_default = 65536u;
...
{
    hwmalloc::heap_config config{256u, small_limit_default, large_limit_default,
        tiny_segment_size_default, small_segment_size_default, large_segment_size_default};
    ...
    EXPECT_EQ(config.m_num_small_heaps, 2u); // While this is decreased by one
    EXPECT_EQ(config.m_num_large_heaps, num_large_heaps_default);
}

TEST(heap_config, tiny_segment)
{
    hwmalloc::heap_config config{tiny_limit_default, small_limit_default, large_limit_default,
        8192u, small_segment_size_default, large_segment_size_default};
...
{
    hwmalloc::heap_config config{tiny_limit_default, 4096u, large_limit_default,
        tiny_segment_size_default, small_segment_size_default, large_segment_size_default};

    EXPECT_EQ(config.m_tiny_limit, tiny_limit_default);
    EXPECT_EQ(config.m_small_limit, 4096u); // This changes to the literal value we set
    EXPECT_EQ(config.m_large_limit, large_limit_default);
    EXPECT_EQ(config.m_bucket_shift, bucket_shift_default);
    EXPECT_EQ(config.m_tiny_segment_size, tiny_segment_size_default);
    EXPECT_EQ(config.m_small_segment_size, small_segment_size_default);
    ...
    EXPECT_EQ(config.m_tiny_increment, tiny_increment_default);
    EXPECT_EQ(config.m_num_tiny_heaps, num_tiny_heaps_default);
    EXPECT_EQ(config.m_num_small_heaps, 5u); // This is log2(4096)-log2(128) = 5...
    EXPECT_EQ(config.m_num_large_heaps, 4u); // While this is decreased accordingly
}

TEST(heap_config, small_segment)
{
    hwmalloc::heap_config config{tiny_limit_default, small_limit_default, large_limit_default,
        tiny_segment_size_default, 16384u, large_segment_size_default};
...
{
    hwmalloc::heap_config config{tiny_limit_default, small_limit_default, 32768u,
        tiny_segment_size_default, small_segment_size_default, large_segment_size_default};
    ...
    EXPECT_EQ(config.m_num_tiny_heaps, num_tiny_heaps_default);
    EXPECT_EQ(config.m_num_small_heaps, num_small_heaps_default);
    EXPECT_EQ(config.m_num_large_heaps, 5u); // This is increased accordingly
}

TEST(heap_config, large_segment)
{
    hwmalloc::heap_config config{tiny_limit_default, small_limit_default, large_limit_default,
        tiny_segment_size_default, small_segment_size_default, 131072u};
    ...
    EXPECT_EQ(config.m_tiny_segment_size, tiny_segment_size_default);
    EXPECT_EQ(config.m_small_segment_size, small_segment_size_default);
    EXPECT_EQ(config.m_large_segment_size, 131072u); // This changes to the literal value we set
    EXPECT_EQ(config.m_tiny_increment_shift, tiny_increment_shift_default);
    EXPECT_EQ(config.m_tiny_increment, tiny_increment_default);
    EXPECT_EQ(config.m_num_tiny_heaps, num_tiny_heaps_default);
    EXPECT_EQ(config.m_num_small_heaps, num_small_heaps_default);
...
{
    hwmalloc::heap_config config{200u, 500u, 20000u, 1000u, 3000u, 100000u};
...
{
    EXPECT_THROW(
        (hwmalloc::heap_config{2048u, 1024u, large_limit_default, tiny_segment_size_default,
...
{
    EXPECT_THROW(
        (hwmalloc::heap_config{tiny_limit_default, 131072u, 65536u, tiny_segment_size_default,
            small_segment_size_default, large_segment_size_default}),
        std::runtime_error);
}
...
{
    EXPECT_THROW((hwmalloc::heap_config{2048u, small_limit_default, large_limit_default, 1024u,
                     small_segment_size_default, large_segment_size_default}),
        std::runtime_error);
}
...
{
    EXPECT_THROW((hwmalloc::heap_config{tiny_limit_default, 131072u, large_limit_default,
                     tiny_segment_size_default, 65536u, large_segment_size_default}),
        std::runtime_error);
}

TEST(heap_config, validate_large_limit_segment_size)
{
    EXPECT_THROW((hwmalloc::heap_config{tiny_limit_default, small_limit_default, 262144u,
                     tiny_segment_size_default, small_segment_size_default, 131072u}),
        std::runtime_error);
}
